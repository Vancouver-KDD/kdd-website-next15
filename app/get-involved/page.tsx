  ...
  return (
    <div className="flex w-full flex-col items-center">
      <div className="flex w-full max-w-6xl flex-col">
        {/* Hero Section */}
        <section className="flex flex-col md:flex-row w-full items-center gap-12 px-6 py-12 md:py-20">
          <div className="flex-1 w-full max-w-[588px] flex flex-col items-start self-center">
            <div>
              <span className={title({size: 'lg'})}>KDD </span>
              <h1 className={title({color: 'kdd', size: 'lg', className: 'pl-1 italic inline-block py-2 pr-4'})}>운영진 모집</h1>
            </div>
            <Spacer y={4} />
          ...
          <div className="flex-1 w-full relative min-h-[250px] md:min-h-[400px] rounded-2xl overflow-hidden shadow-2xl">
            <Image 
