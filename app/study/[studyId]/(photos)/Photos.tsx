...
export default function Photos({photos, studyId}: {photos: Photo[]; studyId: string}) {
        ...
        <>
          <Gallery
            ...
            movePhoto={async (oldIndex, newIndex) => {
              ...
              if (idToken) {
                const {success, message} = await moveStudyPhoto(
                  idToken,
                  studyId,
                  oldIndex,
                  newIndex
                ...
                admin && (
                  <Button
                    ...
                    onPress={async () => {
                      ...
                      const {success, message} = await deleteStudyPhoto(
                        idToken,
                        studyId,
