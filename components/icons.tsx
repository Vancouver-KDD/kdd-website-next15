...
export const ThreadsIcon = (props: IconSvgProps) => (
  <svg fill="currentColor" viewBox="0 0 16 16" width={20} height={20} {...props}>
...
export const LinkedInIcon = (props: IconSvgProps) => (
  <svg fill="currentColor" x="0px" y="0px" width={20} height={20} viewBox="0 0 50 50" {...props}>
